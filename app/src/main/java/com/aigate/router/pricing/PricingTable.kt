...
object PricingTable {
    ...
    val BUNDLED: List<ModelPricing> = listOf(
        ...
        p("ollama", "*", 0.0, 0.0),
        // Счёт на самом устройстве денег не стоит: ни системная модель, ни
        // скачанные веса не тарифицируются.
        p("device-gemini-nano", "*", 0.0, 0.0),
        p("local-llamacpp", "*", 0.0, 0.0),
        p("local-litertlm", "*", 0.0, 0.0),
    )
